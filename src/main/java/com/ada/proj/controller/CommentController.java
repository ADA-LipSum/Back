    ...
    @Operation(
        ...
        public ResponseEntity<ApiResponse<CommentResponse>> updateComment(
            ...
            @Valid @RequestBody CommentUpdateRequest req
                ...
                return ResponseEntity.ok(ApiResponse.success(commentService.updateComment(commentId, req)));
    }
    ...
    @Operation(
        ...
        public ResponseEntity<ApiResponse<Map<String, Object>>> toggleLike(
            @PathVariable Long commentId
                ...
                return ResponseEntity.ok(ApiResponse.success(commentService.toggleLike(commentId)));
    }
    ...
    @Operation(
        ...
        public ResponseEntity<ApiResponse<Map<String, Object>>> toggleFixed(
            @PathVariable Long commentId
                ...
                return ResponseEntity.ok(ApiResponse.success(commentService.toggleFixed(commentId)));
    }
}